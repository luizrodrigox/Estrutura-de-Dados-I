...
//função para prencher as respostas para cada aluno.
...
//função para corrigir as questões e mostrar porcentagem de aprovação.
void corrijequestoes(int questoes, char *gabarito, char **alunos, float *notas)
{
    ...
    printf("-------------------------------------------");
    printf("\nPorcentagem de alunos aprovados: %% %.2f\n", (paprovados / ALUNOS) * 100); //exibindo a porcentagem de aprovação.
}
